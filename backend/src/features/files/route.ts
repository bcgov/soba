...
// the `submissionId` field and authorizes a write on that submission. Accept any file field name
// (Form.io's fileKey is configurable; the component uploads one at a time).
